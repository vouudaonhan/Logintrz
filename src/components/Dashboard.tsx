  ...
  return (
    <div className="relative min-h-screen">
      ...
      <video
        ...
        className="video-bg"
      >
        <source src="https://nwphgyovyjvfkexhcpix.supabase.co/storage/v1/object/public/Vd_bgr/46c99f8934d4aaf0105e2be19c909fbd.mp4" type="video/mp4" />
      ...
      <div className="container mx-auto px-4 py-8 relative z-10">
        <div className="max-w-4xl mx-auto">
          <div className="bg-white/50 backdrop-blur-md rounded-2xl shadow-2xl overflow-hidden">
